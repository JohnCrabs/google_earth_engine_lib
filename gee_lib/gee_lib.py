...
S05_NO2_COLUMN_NUMBER_DENSITY_DKEY = 'NO2_COLUMN_NUMBER_DENSITY'
...
S05_O3_COLUMN_NUMBER_DENSITY_DKEY = 'O3_COLUMN_NUMBER_DENSITY'
_S05_O3_EFFECTIVE_TEMPERATURE_DKEY = 'O3_EFFECTIVE_TEMPERATURE'

S05_SO2_COLUMN_NUMBER_DENSITY_DKEY = 'S02_COLUMN_NUMBER_DENSITY'
...
DICT_FULL_DATASET = {
    GSV_DS_LANDSAT_1_T1_DKEY: {  # LANDSAT 1 DATASET
        ...
        BANDS_DKEY: {
            S05_SO2_COLUMN_NUMBER_DENSITY_DKEY: 'SO2_column_number_density',
